...
// 
//
public static class ReserveHttpNamespace
{
    ...
    {
        string sddl = createSddl(domainName, accountName);
    ...
    static string createSddl(string domainName ,string account)
    {
        string sid = new NTAccount(domainName , account).Translate(
